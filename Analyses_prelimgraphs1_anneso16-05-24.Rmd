...
```{r}
# Import tidy data
tidy_data <- read.csv("final_files/tidy_data_update25-04-24.csv")[,-1]
...
tax_table <- read.csv("final/tax_table_update26-04-24.csv")[,-1]
...
fun_table_macrofaune_surface_guilds_family <- read.csv("final_files/fun_table/fun_table_macrofaune_surface_guilds_family.csv")[,-1]

numberofquery_family <- n_distinct(fun_table_macrofaune_surface_guilds_family$matchName) # 3289 taxa assigned to families
print(numberofquery_family)
numberofguilds_family <- n_distinct(fun_table_macrofaune_surface_guilds_family$guildName) # 48 guilds
...
fun_table_macrofaune_surface_guilds_familyonly <- fun_table_macrofaune_surface_guilds_family[fun_table_macrofaune_surface_guilds_family$queryName == fun_table_macrofaune_surface_guilds_family$matchName, ]

numberofquery_familyonly <- n_distinct(fun_table_macrofaune_surface_guilds_familyonly$matchName) # 78 families
print(numberofquery_familyonly)
numberofguilds_familyonly <- n_distinct(fun_table_macrofaune_surface_guilds_familyonly$guildName) # 14 guilds
print(numberofguilds_familyonly)
```

```{r}
# Import fun_table (interactions)
fun_table_macrofaune_surface_interactions_family <- read.csv("final_files/fun_table/fun_table_macrofaune_surface_interactions_family.csv")

# Count the number of interaction per taxa
numberofinteractions_taxa <- aggregate(resourceName ~ matchName, data = fun_table_macrofaune_surface_interactions_family, FUN = length)
```
...
ggsave("results/Analyses_prelimgraphs1/graph_number_of_taxa_in_each_family.png", width = 10, height = 5)
...
ggsave("results/Analyses_prelimgraphs1/Venn_number_of_families.png", width = 10, height = 5)
```
...
### herbivores
fun_herbivore <- fun_table_macrofaune_surface_guilds_familyonly[which(fun_table_macrofaune_surface_guilds_familyonly$guildName=='herbivore'),]
linked_data$guild_herbivore <- fun_herbivore$guildName[match(linked_data$family, fun_table_macrofaune_surface_guilds_familyonly$matchName)]
...
fun_regulator <- fun_table_macrofaune_surface_guilds_familyonly[which(fun_table_macrofaune_surface_guilds_familyonly$guildName=='predator' | fun_table_macrofaune_surface_guilds_familyonly$guildName=='parasitoid'),]
linked_data$guild_regulator <- fun_regulator$guildName[match(linked_data$family, fun_table_macrofaune_surface_guilds_familyonly$matchName)]
...
ggsave("results/Analyses_prelimgraphs1/graph_number_of_taxa_herbivoresORregulators.png", width = 18, height = 7)
...
ggsave("results/Analyses_prelimgraphs1/Venn_number_of_herbivoresORregulators.png", width = 8, height = 8)
```
...
ggsave("results/Analyses_prelimgraphs1/graph_number_of_interactions.png", width = 5, height = 5)
...
```{r}
fun_table_macrofaune_surface_diets_family <- read.csv("final_files/fun_table/fun_table_macrofaune_surface_diets_family.csv")

fun_table_macrofaune_surface_groups_family <- read.csv("final_files/fun_table/fun_table_macrofaune_surface_groups_family.csv")
```
