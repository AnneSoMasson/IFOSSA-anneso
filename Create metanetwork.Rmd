...
fun_nematodes_1 <- fun_nematodes_0 %>%
  tibble(tax_name(fun_nematodes_0$name, get = c("kingdom", "phylum", "class", "order", "family", "genus"), db = "itis")) %>% 
  unnest() %>% 
...
test <- tbl_df(tax_name(fun_nematodes_0$name, get = c("kingdom", "phylum", "class", "order", "family", "genus"), db = "itis"))
...
fun_inter_macrofaune <- bind_rows(fun_macrofaune_surface_0, fun_macrofaune_aerial_0, fun_macrofaune_foliar_0)

fun_inter_mo <- bind_rows(fun_bacteria_1, fun_fungi_1, fun_cercozoa_1)
