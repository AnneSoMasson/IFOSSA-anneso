...
full_macrofaune <-full_macrofaune %>% 
mot_a_supprimer <- "arbre"

full_macrofaune[full_macrofaune$Ligne %in% 5222, "full_uhbr"] <- gsub("mot_a_supprimer", "", full_macrofaune[full_macrofaune$Ligne %in% 5258, "full_uhbr"])
...
install.packages("C:/Users/assma/Downloads/GratinNavigatoR_1.0.0.tar.gz", repos=NULL, type='source', dependencies = TRUE)
...
guilds_info <- get.interactions(sciName =  c( "Pratylenchus"), endpoint = endpoint_url)
