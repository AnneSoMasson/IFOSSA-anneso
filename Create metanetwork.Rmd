...
fun_micro_arthropodes_0 <- micro_arthropodes_all_1 %>%
  tibble(tax_name(micro_arthropodes_all_1$best_ID, get = c("kingdom", "phylum", "class", "order", "family", "genus"), db = "itis")) %>% 
  unnest() %>% 
...
test <- tbl_df(tax_name("Pratylenchus", get = c("kingdom", "phylum", "class", "order", "family", "genus"), db = "itis"))
...
test <- tbl_df(tax_name(fun_nematodes_0[1:5,]$name, get = c("kingdom", "phylum", "class", "order", "family", "genus"), db = "itis"))
