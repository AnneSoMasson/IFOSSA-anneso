...
write.csv(tax_macrofauna_surface_2, "intermediate_files/taxize/tax_macrofauna_surface_taxizeoutput.csv")
```
...
write.csv(taxnotfound_ncbianditis[,-1], "intermediate_files/taxize/tax_macrofauna_surface_taxnotfound_ncbianditis.csv") # Fill cells with info found on internet, save it to x_mod and import it
taxfound_manually <- read.csv("intermediate_files/taxize/tax_macrofauna_surface_taxnotfound_ncbianditis_mod.csv", sep = ";")
...
write.csv(tax_macrofauna_aerial_2, "intermediate_files/taxize/tax_macrofauna_aerial_taxize_output.csv")
```
...
keepitis <- c(subset(taxnotfoundonedb, db == 'ncbi')$query)
taxnotfound_ncbianditis <- subset(taxnotfoundboth,duplicated(query)) # These are the taxa not found in any database. We will export the list, fill it manually and reimport it.
write.csv(taxnotfound_ncbianditis[,-1], "intermediate_files/taxize/tax_macrofauna_aerial_taxnotfound_ncbianditis.csv") # Fill cells with info found on internet, save it to x_mod and import it
taxfound_manually <- read.csv("intermediate_files/taxize/tax_macrofauna_aerial_taxnotfound_ncbianditis_mod.csv", sep = ";")
taxfound_manually <- taxfound_manually[complete.cases(taxfound_manually$kingdom),-c(9,10)]
...
write.csv(tax_macrofauna_foliar_2, "intermediate_files/taxize/tax_macrofauna_foliar_taxizeoutput.csv")
```
...
keepitis <- c(subset(taxnotfoundonedb, db == 'ncbi')$query)
taxnotfound_ncbianditis <- subset(taxnotfoundboth,duplicated(query)) # These are the taxa not found in any database. We will export the list, fill it manually and reimport it.
write.csv(taxnotfound_ncbianditis[,-1], "intermediate_files/taxize/tax_macrofauna_foliar_taxnotfound_ncbianditis.csv") # Fill cells with info found on internet, save it to x_mod and import it
taxfound_manually <- read.csv("intermediate_files/taxize/tax_macrofauna_foliar_taxnotfound_ncbianditis_mod.csv", sep = ";")
taxfound_manually <- taxfound_manually[complete.cases(taxfound_manually$kingdom),-c(9,10)]
...
write.csv(tax_nematodes_2, "intermediate_files/taxize/tax_nematodes_taxizeoutput.csv")
```
...
write.csv(tax_micro_arthropodes_2, "intermediate_files/taxize/tax_micro_arthropodes_taxizeoutput.csv")
```
...
keepitis <- c(subset(taxnotfoundonedb, db == 'ncbi')$query)
taxnotfound_ncbianditis <- subset(taxnotfoundboth,duplicated(query)) # These are the taxa not found in any database. We will export the list, fill it manually and reimport it.
write.csv(taxnotfound_ncbianditis[,-1], "intermediate_files/taxize/tax_micro_arthropodes_taxnotfound_ncbianditis.csv") # Fill cells with info found on internet, save it to x_mod and import it
taxfound_manually <- read.csv("intermediate_files/taxize/tax_micro_arthropodes_taxnotfound_ncbianditis_mod.csv", sep = ";")
taxfound_manually <- taxfound_manually[complete.cases(taxfound_manually$kingdom),-c(9,10)]
...
cf script "Update fun_tables_anneso29-05-24.rmd"
...
```{r}
# at genus level (no need to split for family level)
unique_list <- unique(bacteria_tax$genus)
split_list <- split(unique_list, ceiling(seq_along(unique_list)/92))

# generate results for lists 1 to 10 (change numbers manually)
bacteria_guilds_genus_10 <- get.guilds(sciName = split_list[[10]], endpoint = endpoint_url)

bacteria_diets_genus_10 <- get.diets(sciName = split_list[[10]], endpoint = endpoint_url)

bacteria_groups_genus_10 <- get.trophic.groups(sciName = split_list[[10]], endpoint = endpoint_url)

bacteria_interactions_genus_10 <- get.interactions(sciName = split_list[[10]], endpoint = endpoint_url)

# merge lists with results and export results
bacteria_guilds_genus <- bind_rows(bacteria_guilds_genus_1, bacteria_guilds_genus_2, bacteria_guilds_genus_3, bacteria_guilds_genus_4, bacteria_guilds_genus_5, bacteria_guilds_genus_6, bacteria_guilds_genus_7, bacteria_guilds_genus_8, bacteria_guilds_genus_9, bacteria_guilds_genus_10)
write.csv(apply(bacteria_guilds_genus,2,as.character), "final_files/fun_table/genus/fun_bacteria_guilds_genus.csv")

write.csv(apply(bacteria_diets_genus_4,2,as.character), "final_files/fun_table/genus/fun_bacteria_diets_genus.csv")

write.csv(apply(bacteria_groups_genus_4,2,as.character), "final_files/fun_table/genus/fun_bacteria_groups_genus.csv")

bacteria_interactions_genus <- fill(bacteria_interactions_genus_1)
...
```{r}
# at genus level (no need to split for family level)
unique_list <- unique(fungi_tax$genus)
split_list <- split(unique_list, ceiling(seq_along(unique_list)/92))

# generate results for lists 1 to 5 (change numbers manually)
fungi_guilds_genus_5 <- get.guilds(sciName = split_list[[5]], endpoint = endpoint_url)

fungi_diets_genus_5 <- get.diets(sciName = split_list[[5]], endpoint = endpoint_url)

fungi_groups_genus_5 <- get.trophic.groups(sciName = split_list[[5]], endpoint = endpoint_url)

fungi_interactions_genus_5 <- get.interactions(sciName = split_list[[5]], endpoint = endpoint_url)

# merge lists with results and export results
fungi_guilds_genus <- bind_rows(fungi_guilds_genus_1, fungi_guilds_genus_2, fungi_guilds_genus_3, fungi_guilds_genus_4, fungi_guilds_genus_5)
write.csv(apply(fungi_guilds_genus,2,as.character), "final_files/fun_table/genus/fun_fungi_guilds_genus.csv")

fungi_diets_genus <- bind_rows(fungi_diets_genus_1, fungi_diets_genus_2, fungi_diets_genus_3, fungi_diets_genus_4, fungi_diets_genus_5)
write.csv(apply(fungi_diets_genus,2,as.character), "final_files/fun_table/genus/fun_fungi_diets_genus.csv")

fungi_groups_genus <- bind_rows(fungi_groups_genus_1, fungi_groups_genus_2, fungi_groups_genus_3, fungi_groups_genus_4, fungi_groups_genus_5)
write.csv(apply(fungi_groups_genus,2,as.character), "final_files/fun_table/genus/fun_fungi_groups_genus.csv")

fungi_interactions_genus <- bind_rows(fungi_interactions_genus_1, fungi_interactions_genus_2, fungi_interactions_genus_3, fungi_interactions_genus_4, fungi_interactions_genus_5)
