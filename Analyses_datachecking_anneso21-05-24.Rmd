...
## Lists of unique taxa (old version)

```{r}
# List unique taxa per community and per taxonomic level and export the results
tax_table_macrofauna_surface_K <- as.data.frame(unique(tax_table_macrofauna_surface$kingdom))
tax_table_macrofauna_surface_P <- as.data.frame(unique(tax_table_macrofauna_surface$phylum))
tax_table_macrofauna_surface_C <- as.data.frame(unique(tax_table_macrofauna_surface$class))
tax_table_macrofauna_surface_O <- as.data.frame(unique(tax_table_macrofauna_surface$order))
tax_table_macrofauna_surface_F <- as.data.frame(unique(tax_table_macrofauna_surface$family))
tax_table_macrofauna_surface_G <- as.data.frame(unique(tax_table_macrofauna_surface$genus))
tax_table_macrofauna_surface_S <- as.data.frame(unique(tax_table_macrofauna_surface$species))

# Bind the objects tax_table_macrofauna_surface_X and export the results
tax_table_listoftaxa_macrofauna_surface <- Reduce(function(x,y) merge(x = x, y = y, by = 0, all = TRUE, sort = FALSE)[-1], 
       list(data.frame(tax_table_listoftaxa_macrofauna_surface_K, row.names = NULL), 
            data.frame(tax_table_listoftaxa_macrofauna_surface_P, row.names = NULL),
            data.frame(tax_table_listoftaxa_macrofauna_surface_C, row.names = NULL),
            data.frame(tax_table_listoftaxa_macrofauna_surface_O, row.names = NULL),
            data.frame(tax_table_listoftaxa_macrofauna_surface_F, row.names = NULL),
            data.frame(tax_table_listoftaxa_macrofauna_surface_G, row.names = NULL),
            data.frame(tax_table_listoftaxa_macrofauna_surface_S, row.names = NULL)))

#write.csv(tax_table_listoftaxa_macrofauna_surface,"intermediate_files/datachecking/tax_table_listoftaxa_macrofauna_surface.csv")

# Replace "macrofauna_surface" by the other communities to generate all results
```
...
```{r}
# Import fun_tables
fun_table_macrofauna_surface_guilds_family <- read.csv("final_files/fun_table/family/fun_macrofauna_surface_guilds_family.csv")[,-1] # or read.csv("x", sep=";") if not working
fun_table_macrofauna_surface_groups_family <- read.csv("final_files/fun_table/family/fun_macrofauna_surface_groups_family.csv")[,-1]
fun_table_macrofauna_surface_diets_family <- read.csv("final_files/fun_table/family/fun_macrofauna_surface_diets_family.csv")[,-1]
fun_table_macrofauna_surface_interactions_family <- read.csv("final_files/fun_table/family/fun_macrofauna_surface_interactions_family.csv")[,-1]
...
fun_table_bacteria_interactions_family <- read.csv("final_files/fun_table/family/fun_bacteria_interactions_family.csv", sep=";")
...
```{r}
# Import fun_tables
fun_table_protists_guilds_family <- read.csv("final_files/fun_table/family/fun_protists_guilds_family.csv", sep=";")
...
write.csv(fun_table_numberofall_ALL_family, "intermediate_files/datachecking/results_fun_family.csv")
```
